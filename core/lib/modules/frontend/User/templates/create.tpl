...
<form name="hr-form" class="hr-form" action="" method="post"  enctype="multipart/form-data">
        ...
        <div class="grid grid440 marginleft120">
        	<div class="paddingtop60">
        		{if $_userProfile.resumeKey}
	           		<div class="note paddingleft40 attach-ico grid grid180 margintop15 paddingright20 attach-resume" id="attached_resume" title="{$_userProfile.resumeKey}">{$_userProfile.resumeKey|substr:5|truncate:20:"...":true}</div>
	                <fieldset class="grid grid200">
	                    <div class="margintop10 file-remove" id="fileaddbtn" attr-file-key="{$_userProfile.resumeKey}">Remove File</div>
	                	<input type="file" id="upload_file" name="upload-file" class="fileselect">
	                    <input type="hidden" id="temp_resume" name="temp-resume" value="">
	               	</fieldset>
               	{else}
               		<div class="note paddingleft40 attach-ico grid grid180 margintop15 paddingright20" id="attached_resume">You can attach your resume if you already have one.</div>
	                <fieldset class="grid grid200">
	                    <div class="margintop10" id="fileaddbtn">Upload Resume</div>                    
	                	<input type="file" id="upload_file" name="upload-file" class="fileselect">
	                    <input type="hidden" id="temp_resume" name="temp-resume" value="">                    
	               	</fieldset>
               	{/if}
    ...
    <div id="block_education">    	
        ...
        {/foreach}
        <div id="addeducation-btn" class="form-add-btn add-education-btn grid">Add Education</div>
    	<div class="clear"></div>        
    </div>
    <div id="block_experience">
        ...
        {/foreach}
        <div id="addexperience-btn" class="form-add-btn add-experience-btn grid">Add Experience</div>
		<div class="clear"></div>
    </div> 
    <div id="block_languages">
        ...
        {/foreach}
        <div id="addlanguage-btn" class="form-add-btn add-language-btn grid paddingleft20 boxsizing">Add language</div>
        <div class="clear"></div>
    </div>    
    <!--Skills-->
    <div id="block_skills">
        ...
        {/foreach}
		<div id="addskill-btn" class="form-add-btn add-skill-btn grid">Add Skill</div>
        <div class="clear"></div>
    </div>        
    <!-- Soft Skills -->
    <div id="block_soft_skills">
        ...
        {/foreach}
        <div id="addlanguage-btn" class="form-add-btn add-language-btn grid paddingleft20 boxsizing">Add soft skill</div>
        <div class="clear"></div>
    </div>    
    <div id="block_bio">
