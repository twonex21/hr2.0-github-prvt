...
global $text_domains, $default_domain, $LC_CATEGORIES, $EMULATEGETTEXT;
$text_domains = array();
...
function T_gettext($msgid) {
	if (_check_locale()) return _gettext($msgid);
