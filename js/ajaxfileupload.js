jQuery
		...
		ajaxFileUpload : function(s) {
			...
			var uploadCallback = function(isTimeout) {
				...
				try {
					if (io.contentWindow) {
						//alert("1"+io.contentWindow.document.body+"---------"+io.contentWindow.document.body.innerHTML);
		...
		uploadHttpData : function(r, type) {
			...
			if (type == "json") {
				...
				var ind_1 = data.indexOf("{");
				var ind_2 = data.indexOf("}");
				data = data.toString();
				data = data.substring(ind_1,ind_2+1); 
				eval("data = " + data);
